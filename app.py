...
Live web twin of the Power BI enterprise reporting suite with real-time scenario simulation.
"""
...
<style>
    ...
    .badge-pass { background-color: #065f46; color: #34d399; padding: 2px 8px; border-radius: 4px; font-weight: bold; }
    .badge-fail { background-color: #7f1d1d; color: #f87171; padding: 2px 8px; border-radius: 4px; font-weight: bold; }
</style>
...
st.markdown("**Enterprise SCM Intelligence** · Plant Capacity · Safety Stock Buffer Health · Working Capital Optimization")
st.markdown("---")
...
with tab2:
    ...
    # Re-calculate simulated safety stock
...
with tab4:
    ...
    st.success(f"🛡️ **{pass_count}/{len(report_df)} Data Quality Rules Passed.** ERP snapshot tables certified for Power BI Dataflow ingestion.")
